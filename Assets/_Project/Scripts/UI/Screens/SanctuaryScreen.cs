...
namespace HNR.UI
{
    ...
    public class SanctuaryScreen : ScreenBase
    {
        ...
        private void ShowEmptyStateMessage()
        {
            ...
            {
                Debug.LogError("[SanctuaryScreen] EmptyStatePrefab not assigned. Check RuntimeUIPrefabConfig.");
                return;
            }

            var emptyObj = Instantiate(emptyStatePrefab, _upgradeCardContainer);
